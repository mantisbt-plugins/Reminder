<?php
/*  http://www.YourMantisHome.com/plugin.php?page=Reminder/bug_feedback_mail.php */
...
$t_project		= plugin_config_get('reminder_feedback_project');
$status			= plugin_config_get('reminder_feedback_status');
